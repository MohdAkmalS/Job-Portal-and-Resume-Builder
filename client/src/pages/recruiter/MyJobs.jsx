...
const MyJobs = () => {
    ...
    const fetchJobs = async () => {
        try {
            const res = await axios.get('https://job-portal-and-resume-builder-pruy.vercel.app/api/jobs/my-jobs', { withCredentials: true });
    ...
    const toggleStatus = async (id) => {
        try {
            await axios.patch(`https://job-portal-and-resume-builder-pruy.vercel.app/api/jobs/${id}/status`, {}, { withCredentials: true });
            fetchJobs(); // Refresh
        } catch (err) {
            console.error(err);
        }
    ...
    const deleteJob = async (id) => {
        ...
        try {
            await axios.delete(`https://job-portal-and-resume-builder-pruy.vercel.app/api/jobs/${id}`, { withCredentials: true });
            // Remove from list
